...
question : "Quel oiseau a une danse de séduction qui ressemble à un moonwalk version forêt tropicale ? ",
    answers : [
        { answer:"Le héron Jackson",
        isCorrect: false,
       
        },

        {
        answer:"Le colibri disco",
        isCorrect: false,
        
        },
        
        {
        answer:"Le paradisier superbe",
        isCorrect: true,
        },
        
        {
        answer:"Le flamant rose funky",
        isCorrect: false,
    }
        ],
    ...
    answers : [
        { answer:"Le pigeon romantique",
        isCorrect: false,
       
        },

        {
        answer:"Le corbeau styliste",
        isCorrect: false,
        
        },
        
        {
        answer:"Le jardinier satin",
        isCorrect: true,
        },
        
        {
        answer:"Le perroquet architecte",
        isCorrect: false,
    }
        ],
...
question : " Lequel de ces oiseaux peut dormir debout... sur une seule patte ? ",
    answers : [
        { answer:"Le canari yogi",
        isCorrect: false,
       
        },

        {
        answer:"La Perruche équilibriste",
        isCorrect: false,
        
        },
        
        {
        answer:"Le flamant rose",
        isCorrect: true,
        },
        
        {
        answer:"Le pingouin ninja",
        isCorrect: false,
    }
        ]
